    ...
    return (
        <section className="py-16 md:py-24 bg-black overflow-hidden">
            <div className="container mx-auto px-6">
                <div className="flex flex-col items-center gap-10 max-w-4xl mx-auto relative text-center">
                    {/* Background Decorative Text */}
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 select-none pointer-events-none opacity-[0.02] whitespace-nowrap hidden sm:block">
                    ...
                    {/* Image Block */}
                    <div className="shrink-0 relative group w-full max-w-md mx-auto">
                        ...
                        {/* Status Badge */}
                        <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 z-20 bg-brand-yellow px-5 py-2 rounded-xl shadow-2xl flex items-center gap-2 border-[3px] border-black">
                    ...
                    {/* Text Block */}
                    <div className="flex-1 space-y-6 sm:space-y-8 relative z-10 pt-4">
                        ...
                        <div className="max-w-2xl mx-auto space-y-5 sm:space-y-6">
                            ...
                            <div className="pt-6 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 border-t border-white/10 uppercase tracking-[0.2em] text-[10px] sm:text-xs font-bold text-zinc-400">
