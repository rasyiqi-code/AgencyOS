...
export async function SiteHeader() {
    ...
    return (
        <>
            <header className="no-print relative md:fixed top-0 w-full z-50 border-b border-white/5 bg-[#0a0a0a]/90 backdrop-blur-md supports-[backdrop-filter]:bg-[#0a0a0a]/80 transition-all duration-300">
