...
export function ServiceListItem({ service }: ServiceListItemProps) {
    ...
    return (
        <div
            className="py-2.5 px-4 sm:px-5 flex flex-row justify-between items-center gap-3 bg-zinc-900/20 hover:bg-zinc-900/40 border-b border-white/5 border-l-2 border-l-brand-yellow rounded-none transition-all duration-300 group relative"
        >
            ...
            <div className="flex-1 min-w-0 flex flex-col justify-center">
                ...
                <div className="flex items-center gap-1 max-w-full">
                    <Link href={`/services/${service.slug || service.id}`} className="marquee-container-db flex-1 min-w-0 block">
