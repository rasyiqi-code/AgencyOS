...
export function VerificationInProgress({ orderId, isId }: VerificationInProgressProps) {
    return (
        <div className="w-full bg-zinc-900/40 border border-zinc-800/80 rounded-2xl p-8 shadow-[0_8px_32px_rgba(0,0,0,0.4)] backdrop-blur-md flex flex-col items-center justify-center text-center h-fit min-h-[360px] animate-in fade-in duration-500">
            ...
            <div className="mt-8 p-4 bg-zinc-950/80 rounded-xl border border-zinc-800/60 text-xs text-zinc-500 flex flex-col sm:flex-row items-center gap-1 sm:gap-2">
