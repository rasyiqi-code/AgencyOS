...
export function StickyCTA({ service, intervalLabel, selectedAddons }: StickyCTAProps) {
    ...
    return (
        ...
        >
            {/* Wrapper luar mengatur lebar maksimum dan posisi padding agar sejajar dengan header px-6 */}
            <div className="max-w-7xl mx-auto px-2 md:px-0">
                <div className="pointer-events-auto flex items-center justify-between gap-4 py-2.5 sm:py-3 px-4 md:px-6 bg-[#0a0a0a]/95 backdrop-blur-xl border border-white/5 border-t-0 shadow-lg shadow-black/80 rounded-b-xl md:rounded-b-2xl">
