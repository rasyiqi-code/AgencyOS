        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {deliverablesList.map((item, i) => (
                    <div key={i} className="flex items-center gap-3 p-3 rounded-xl bg-zinc-900/40 border border-white/5 hover:border-brand-yellow/20 transition-all duration-300 group/item">
                        <div className="flex items-center justify-center w-5 h-5 rounded-full bg-brand-yellow/10 border border-brand-yellow/20 group-hover/item:bg-brand-yellow/20 transition-colors shrink-0">
