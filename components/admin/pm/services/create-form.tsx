...
import { CreatableCategorySelect } from "@/components/admin/services/creatable-category-select";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";
import { Flag, Sparkles, Loader2, ArrowLeft, Package, Plus } from "lucide-react";
import { Textarea } from "@/components/ui/textarea";
import { Popover, PopoverContent, PopoverTrigger } from "@/components/ui/popover";
import { ServiceData } from "@/components/admin/services/edit-service-form";
...
export function CreateServiceForm({ categories = [] }: { categories?: string[] }) {
    ...
    async function onSubmit(event: React.FormEvent<HTMLFormElement>) {
        ...
        try {
            ...
            if (!result.success) {
                throw new Error("Gagal memublikasikan layanan");
            }
                    ...
                    <div className="sticky top-8 space-y-6">
                        ...
                        <div className="rounded-xl border border-white/5 bg-zinc-900/40 overflow-hidden">
                            ...
                            <div className="px-6 py-4 bg-zinc-900/60 border-t border-white/5">
                                <Button
                                    type="submit"
                                    className="w-full bg-blue-600 hover:bg-blue-500 text-white font-medium shadow-lg shadow-blue-500/20 h-10 font-bold uppercase tracking-wider"
