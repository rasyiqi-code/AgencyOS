...
export function RenewSubscriptionButton({ 
    ...
    const handleRenew = async () => {
        ...
        try {
            ...
            const result = await generateRenewalInvoiceFn({
                data: {
                    projectId,
                    amount: parsedAmount,
                    summary
                ...
                <div className="space-y-4 py-4">
                    <div className="space-y-2">
                        ...
                        <Input 
                            ...
                            className="bg-zinc-900 border-zinc-800 focus-visible:ring-blue-500/20 text-white"
                        />
                    ...
                    <div className="space-y-2">
                        ...
                        <Textarea 
                            ...
                            className="bg-zinc-900 border-zinc-800 focus-visible:ring-blue-500/20 resize-none h-24 text-sm text-white"
                        />
                    </div>
                </div>
