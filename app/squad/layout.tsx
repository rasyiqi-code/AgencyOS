...
export default async function SquadLayout({
    ...
    // ⚡ Bolt: Cache global settings queries
    // Expected impact: Prevents redundant database queries on every render and avoids N+1 queries during SSR
