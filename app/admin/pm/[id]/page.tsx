...
import { User, Github, FileText, Activity, MessageSquare, Clock, Calendar } from "lucide-react";
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                                ...
                                <div className="flex flex-col md:flex-row gap-4">
                                    ...
                                    <div className="flex-1 space-y-3">
                                        ...
                                        {project.service.features && (
                                            <ServiceFeaturesList
                                                features={project.service.features as unknown as { text?: string, title?: string }[]}
                                                variant="admin"
                                            />
                                        )}
                                    </div>
                ...
                <div className="lg:col-span-1 space-y-4">
                    ...
                    <div className="rounded-xl border border-white/5 bg-zinc-900/40 overflow-hidden">
                        ...
                        <div className="p-3 space-y-3">
                            <div>
                                <label className="text-[9px] font-bold text-zinc-500 uppercase block mb-1">Developer</label>
                                {project.developerId ? (
                                    <div className="flex items-center gap-2 p-1.5 rounded bg-black/20 border border-white/5">
                                        <div className="w-5 h-5 rounded-full bg-blue-500/20 flex items-center justify-center text-blue-400 text-[10px] font-bold">
                                            {project.developerId.charAt(0).toUpperCase()}
                                        </div>
                                        <span className="text-xs text-zinc-200 truncate">{project.developerId}</span>
                                    </div>
                                ) : (
