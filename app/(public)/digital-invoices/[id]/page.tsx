...
export default async function DigitalInvoicePage(props: { params: Promise<{ id: string }> }) {
    ...
    // ⚡ Bolt Optimization: Replace direct findMany query with cached utility function
    // 🎯 Why: Reuses cached global configuration objects to decrease repetitive DB hits
    // 📊 Impact: Substantially reduces query volume on server during invoice page SSR
