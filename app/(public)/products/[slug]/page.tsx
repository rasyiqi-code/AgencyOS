        ...
        <>
            <BreadcrumbSchema
                items={[
                    ...
                    { name: isId ? 'Produk' : 'Products', item: `${process.env.NEXT_PUBLIC_APP_URL}/${locale}/products` },
                    { name: name, item: `${process.env.NEXT_PUBLIC_APP_URL}/${locale}/products/${product.slug}` },
                ]}
            />
