...
const loader = async () => {
  ...
  const pageSeo = await getPageSeoFn({ data: '/terms' })
...
export const Route = createFileRoute('/terms')({
  ...
  head: ({ loaderData }) => {
    ...
    const title = pageSeo?.title || 'Syarat & Ketentuan'
    const description = pageSeo?.description || 'Syarat & Ketentuan platform AgencyOS.'
          ...
          <div className="space-y-8 text-base md:text-lg">
            ...
            <section className="space-y-4">
              ...
              <ul className="list-disc pl-6 space-y-2 marker:text-brand-yellow">
                <li>
                  <strong className="text-white">Pengembangan Hybrid:</strong> We menyediakan layanan pengembangan perangkat lunak yang menggabungkan AI Generatif dan pengawasan ahli manusia (Human Expert).
                </li>
                <li>
