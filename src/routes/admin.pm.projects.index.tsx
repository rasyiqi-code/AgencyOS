...
// Schema untuk memvalidasi parameter pencarian dan filter
...
function AdminProjectsRoute() {
  ...
  // Sinkronisasi data menggunakan React Query untuk cache terpusat
  ...
  // Fallback bahasa Indonesia sesuai instruksi global
  const isId = true
  ...
  return (
    <div className="w-full py-6 min-w-0 text-left">
      ...
      <div className="flex items-center gap-4 mb-6">
        {/* Kontrol pencarian/filter diintegrasikan dalam ProjectAccordionList */}
      </div>
