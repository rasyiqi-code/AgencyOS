...
function AdminServicesRoute() {
  ...
  // Fallback bahasa Indonesia untuk konsistensi petunjuk global user
  const isId = true
                        ...
                        <div className="flex-1 flex flex-col min-w-0">
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 mb-3">
                            ...
                            <div className="flex items-center gap-2 group/detail">
                              ...
                              <div className="flex-1 min-w-0">
                                <span className="text-[10px] text-zinc-600 uppercase tracking-wider block">Interval</span>
                            ...
                            <div className="flex items-center gap-2 group/detail">
                              ...
                              <div className="flex-1 min-w-0">
                                <span className="text-[10px] text-zinc-600 uppercase tracking-wider block">Price Model</span>
                                <span className="text-xs text-zinc-400 font-medium">
