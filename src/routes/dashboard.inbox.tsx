        ...
        <div className="flex h-[calc(100vh-140px)] rounded-2xl border border-white/5 bg-zinc-950/50 backdrop-blur-xl overflow-hidden shadow-2xl shadow-black/50">
                ...
                <div className="p-3 border-b border-white/5 space-y-3 bg-zinc-950/20">
                    ...
                    <div className="relative">
                        ...
                        <Input
                            ...
                            className="pl-8 bg-zinc-900/50 border-white/5 h-8 text-xs focus-visible:ring-1 focus-visible:ring-white/10 text-zinc-200"
                        />
                    </div>
                </div>
            ...
            <div className={cn(
                ...
                {!selectedTicketId ? (
                    ...
                    <>
                        <div className="px-4 py-3 md:px-6 md:py-4 border-b border-white/5 flex items-center gap-3 bg-zinc-900/20 backdrop-blur-sm z-10 text-left">
                            <Button
                                variant="ghost"
                                size="icon"
                                ...
                                {messages.map((m, idx) => {
                                    ...
                                    return (
                                        <div
                                            key={m.id || idx}
                                            className={cn(
                                                "flex gap-3 md:gap-4 max-w-[90%] md:max-w-[85%] text-left",
                            ...
                            <form onSubmit={handleSendMessage} className="flex gap-2 relative items-end">
                                ...
                                <div className="relative flex-1">
                                    <Input
                                        ...
                                        className="w-full bg-black/40 border-white/10 text-zinc-200 placeholder:text-zinc-600 focus-visible:ring-blue-500/30 h-10 rounded-xl pl-3 pr-3 text-sm focus:outline-none focus:ring-0"
                                    />
                                </div>
                                <Button
                                    type="submit"
