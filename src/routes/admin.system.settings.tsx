...
// Definisi rute untuk halaman pengaturan umum admin
export const Route = createFileRoute('/admin/system/settings')({
  loader: async () => {
    // Ambil data pengaturan umum dari server function
...
function AdminSettingsRoute() {
  ...
  // Format data pengaturan ke struktur data yang diharapkan oleh formulir
  const contactData = {
