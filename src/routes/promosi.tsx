  ...
  head: () => {
    return {
      meta: [
        ...
        { name: 'description', content: 'Temukan berbagai promo menarik, diskon spesial, dan penawaran terbatas untuk layanan kami.' },
      ]
    }
  },
...
function PromosiPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white pt-32 pb-20 selection:bg-brand-yellow/30">
          ...
          <div className="columns-1 gap-8 sm:columns-2 lg:columns-3">
            {promotions.map((promo: any) => (
              <PromoCard
                ...
                promotion={{
                  ...promo,
                  endDate: promo.endDate ? promo.endDate : null
                }}
              />
            ))}
          </div>
